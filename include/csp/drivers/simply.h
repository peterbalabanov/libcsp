...
#define SIMPLY_API_VERSION_MINOR              1
#define SIMPLY_API_VERSION_BUILD              1
...
**    global variables
***************************************************************************************************/
DLL extern const int simply_api_version_major;
DLL extern const int simply_api_version_minor;
DLL extern const int simply_api_version_build;
